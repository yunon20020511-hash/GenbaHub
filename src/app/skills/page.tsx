    ...
    <div className="p-8 max-w-7xl mx-auto">
      ...
      <div className="flex items-center gap-4 mb-6">
        <input
          ...
          className="flex-1 max-w-sm bg-[#1e293b] text-white text-sm rounded-xl px-4 py-2.5 outline-none border border-[#334155] focus:border-cyan-500/50 placeholder:text-slate-600"
        />
